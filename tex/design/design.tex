...
\begin{document}
	...
	\section{Network Communication}
		...
		As introduced within the background section (see \fullref{communicationTechnologies}) there exist several technologies capable of handling the actual communication with a web-server; most notably Web-Sockets and Web-RTC. However, due to the use of a dedicated game-server running Node, Web-Sockets is our chosen communication technology.
