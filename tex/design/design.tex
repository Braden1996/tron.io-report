...
\begin{document}
	...
	\section{Software Development Process}
		...
		In order to manage the various short-term goals throughout development, a todo-list (in the form of a plaintext file) has been maintained. The purpose of which was to help maintain an efficient workmflow and provide a medium for documenting design thoughts between development sessions.
		...
		\subsection{Package Scripts}
			...
			Below is a curated list of the available scripts, along with a short description of their purpose. However, please mind that some reflect ideas we have yet to discuss. (for more detail, please see \fullref{sec:reactUniversally})
			\begin{formal}
				\input{packagescripts.tex}
			\end{formal}

	The reader can find a curated list of these scripts within the \emph{package.json}
	Below is a curated list of these scripts, along with a short description of the purpose they solve:\footnote{Also, when a developer attempts to push to our GitHub repository our unit-test are automatically performed; aborting the push upon failure.}
